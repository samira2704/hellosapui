		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello SAP",
									"targetURL": "#bashellosapui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bashellosapui-display": {
								"semanticObject": "bashellosapui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bas.hellosapui",
									"url": sap.ui.require.toUrl("bas/hellosapui")
								}
							}
						}
					}
